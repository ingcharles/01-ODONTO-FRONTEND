...
@Component({
  selector: 'create-diagnostico-plan',
  templateUrl: './create-diagnostico-plan.component.html',
  styleUrls: ['./create-diagnostico-plan.component.css']
})
export class CreateDiagnosticoPlanComponent {
